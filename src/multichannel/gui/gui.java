...
public class gui {
    ...
    public void creategui() {
        ...
        // Erinnerung-Panel
        JPanel pa_reminder = new JPanel();
        labelminutes.setVisible(false);
        final JCheckBox checkreminder = new JCheckBox("Erinnerung setzen");
        checkreminder.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                if (checkreminder.isSelected() == true) {
        ...
        buttonsendtime.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                sendtime = new guidatepicker(frame).setPickedDate();
        ...
        pa_reminder.setLayout(new FlowLayout(FlowLayout.LEFT));
        pa_reminder.add(checkreminder);
        pa_reminder.add(Box.createRigidArea(new Dimension(5, 0)));
        pa_reminder.add(timeList);
        pa_reminder.add(Box.createRigidArea(new Dimension(5, 0)));
        pa_reminder.add(labelminutes);
